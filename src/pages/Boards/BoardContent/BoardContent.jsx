...
function BoardContent ({ board, createColumn, createCard, moveColumns, moveCards, moveCardsOtherColumn, deleteColumn }) {
  ...
  return (
    <DndContext collisionDetection={closestCorners} onDragStart={handleDragStart} onDragOver={handleDragOver} onDragEnd={handleDragEnd} sensors={sensor}>
      <Box sx={{
        ...
        <ListColumns createCard={createCard} columns={orderedColumns} createColumn={createColumn} deleteColumn={deleteColumn}/>
